...
}
{
    ...
    verificación de tipos. & Black, isort, flake8, mypy, pre-commit. \\
    Pruebas & Ejecución de pruebas unitarias por módulo y validación funcional de
    cambios. & Pytest. \\
    Integración y despliegue & Ejecución reproducible del pipeline completo en
    distintos modos. & Docker Compose, GHCR, Makefile. \\
    Documentación & Redacción de memoria técnica y mantenimiento de documentación
    del proyecto. & LaTeX, Visual Studio Code. \\
}
