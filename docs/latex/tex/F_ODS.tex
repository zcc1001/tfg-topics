...
La ingeniería del software, tiene un impacto profundo y directo en el consumo
de recursos naturales, el desarrollo socioeconómico y la equidad social. Por
tanto, el diseño, arquitectura y desarrollo de este sistema de análisis
temático se ha llevado a cabo bajo el prisma de sostenibilidad ambiental,
social y económica.
...
El auge reciente de la \acrshort{ai} y de los modelos de \acrshort{nlp} ha
traído consigo un incremento alarmante en la huella de carbono, debido a la
ingente cantidad de recursos computacionales y energéticos necesarios para su
entrenamiento. En este proyecto, se han aplicado principios de \textit{Green
    AI} (IA verde) para minimizar drásticamente el impacto medioambiental.
...
en disco (\acrshort{io}), reduciendo notablemente el consumo energético del
procesador y el disco durante las pesadas fases de tratamiento de texto.
...
tecnologías libres y gratuitas. El backend (Python, Pandas, Optuna) y el motor
de visualización (Streamlit) no exigen licencias comerciales de pago.
