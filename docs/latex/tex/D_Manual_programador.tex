...
técnico la implementación de la aplicación \textbf{TFG Topics}, modificar su
código fuente o añadir nuevas funcionalidades.
...
\begin{itemize}
    ...
    \item \textbf{backend-processing}: Motor analítico que ejecuta las fases de preprocesamiento de texto (\acrshort{nlp}) y el entrenamiento de los algoritmos de modelado de tópicos (\acrshort{lda}, BERTopic, Top2Vec, FASTopic), evaluando hiperparámetros.
...
\imagen{diagramas/arquitectura_general.png}{Diagrama de componentes global del sistema y flujo de datos persistente}
